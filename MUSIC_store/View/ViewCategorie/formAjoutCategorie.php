    ...
    <div class="container_f"> 
        <form action="index.php?action=Save" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <input type="text"  name="libelleCategorie" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="donner un libelle pour votre categorie" required>
            </div><br/>

            <div class="form-group">
                <label for="exampleFormControlFile1"><b>Image de categorie</b></label><br/>
